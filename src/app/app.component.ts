...
export class AppComponent {
  ...
  booksToBeShown:Array<book>=this.books;
  matchingText:string="";

  updateMatchingText(text:string){
    this.matchingText=text;
    this.updateBooksToBeShown();
  }

  updateBooksToBeShown(){
    if(this.matchingText==""){
      this.booksToBeShown=this.books;
    }
    else{
      this.matchingText=this.matchingText.toLowerCase();
      this.booksToBeShown=this.books.filter((book)=>{
          let bookTitle=book.title;
          bookTitle=bookTitle.toLowerCase();
          return bookTitle.includes(this.matchingText);
      });
    }
  }
}
